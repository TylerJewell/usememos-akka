...
A `LICENSE-usememos` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [usememos/memos](https://github.com/usememos/memos), Copyright
2025 Memos, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../usememos-port/specs/SPEC-001-usememos.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
